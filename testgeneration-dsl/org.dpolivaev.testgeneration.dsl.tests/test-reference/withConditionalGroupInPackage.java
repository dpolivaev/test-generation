...
class _first_StrategyFactory {
  ...
  RequirementBasedStrategy first() {
    ...
    _strategy.addRule(RuleBuilder.Factory.iterate(" somepackage._first_StrategyFactory.condition1#" +  _instanceId).over(new ValueProvider(){
    ...
    _strategy.addRule(RuleBuilder.Factory._if(new Condition(){
      @Override public boolean isSatisfied(PropertyContainer propertyContainer) {
        return propertyContainer.<Boolean>get(" somepackage._first_StrategyFactory.condition1#" +  _instanceId);
