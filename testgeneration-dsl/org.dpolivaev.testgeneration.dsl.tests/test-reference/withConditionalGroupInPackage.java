...
File 2 : somepackage/_MyFile_first_StrategyFactory.java
...
class _MyFile_first_StrategyFactory {
  ...
  RequirementBasedStrategy first() {
    ...
    _strategy.addRule(RuleBuilder.Factory.iterate(" somepackage._MyFile_first_StrategyFactory.condition1#" +  _instanceId).over(new ValueProvider(){
    ...
    _strategy.addRule(RuleBuilder.Factory._if(new Condition(){
      @Override public boolean isSatisfied(PropertyContainer propertyContainer) {
        return propertyContainer.<Boolean>get(" somepackage._MyFile_first_StrategyFactory.condition1#" +  _instanceId);
