...
class _first_StrategyFactory {
  ...
  RequirementBasedStrategy first() {
    ...
    _strategy.addRule(RuleBuilder.Factory.iterate(" somepackage/MyFile.testspec#/0/@strategies.0/@ruleGroups.0/@condition/@expr").over(new ValueProvider(){
    ...
    _strategy.addRule(RuleBuilder.Factory._if(new Condition(){
      @Override public boolean isSatisfied(PropertyContainer propertyContainer) {
        return propertyContainer.<Boolean>get(" somepackage/MyFile.testspec#/0/@strategies.0/@ruleGroups.0/@condition/@expr");
