...
class _MyFile_first_StrategyFactory {
  ...
  RequirementBasedStrategy first() {
    ...
    _strategy.addRule(RuleBuilder.Factory.iterate(" _MyFile_first_StrategyFactory.condition2#" +  _instanceId).over(new ValueProvider(){
      @Override public Object value(PropertyContainer propertyContainer) {
        Boolean _condition = propertyContainer.<Boolean>get(" _MyFile_first_StrategyFactory.condition1#" +  _instanceId) && condition2(propertyContainer);
        return _condition;
    }}).asDefaultRule());
