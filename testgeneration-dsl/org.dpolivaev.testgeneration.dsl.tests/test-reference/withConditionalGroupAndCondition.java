...
class _first_StrategyFactory {
  ...
  RequirementBasedStrategy first() {
    ...
    _strategy.addRule(RuleBuilder.Factory.iterate(" /MyFile.testspec#/0/@strategies.0/@ruleGroups.0/@ruleGroups.0/@condition/@expr").over(new ValueProvider(){
      @Override public Object value(PropertyContainer propertyContainer) {
        Boolean _condition = propertyContainer.<Boolean>get(" /MyFile.testspec#/0/@strategies.0/@ruleGroups.0/@condition/@expr") && condition2(propertyContainer);
        return _condition;
    }}).asDefaultRule());
    _strategy.addRule(RuleBuilder.Factory._if(new Condition(){
      @Override public boolean isSatisfied(PropertyContainer propertyContainer) {
        return propertyContainer.<Boolean>get(" /MyFile.testspec#/0/@strategies.0/@ruleGroups.0/@ruleGroups.0/@condition/@expr");
    }}).iterate("y").over(new ValueProvider(){
      @Override public Object value(PropertyContainer propertyContainer) {return 5;
    }}));
