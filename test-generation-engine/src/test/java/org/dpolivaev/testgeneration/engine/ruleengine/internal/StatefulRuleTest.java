...
public class StatefulRuleTest {
	...
	public void removesItself() {
		final StatefulRule statefulRule = new LazyStatefulRule(Collections.<String>emptySet(), Condition.TRUE, null, null);
	...
	public void ruleCanNotRemoveOtherRule() {
		final StatefulRule statefulRule = new LazyStatefulRule(Collections.<String>emptySet(), Condition.TRUE, null, null);
		final StatefulRule statefulRule2 = new LazyStatefulRule(Collections.<String>emptySet(),Condition.TRUE, null, null);
