...
public class ParkingCostsCalculatorTest {
	...
	private ParkingCostsCalculator parkingCostsCalculator = new ParkingCostsCalculator();
...
//
	...
	public void valetParkingOneMinute_costs12() {
		int costs = parkingCostsCalculator.selectLot("Valet Parking")
		...
		assertThat(costs, CoreMatchers.equalTo(12));
	}
	...
	public void valetParkingZeroMinutes_costs0() {
		...
		assertThat(costs, CoreMatchers.equalTo(0));
	}
	...
	public void valetParkingFiveHoursOneMinute_costs18() {
		...
		assertThat(costs, CoreMatchers.equalTo(18));
	}
	...
	public void valetParkingOneWeek_costs18x7() {
		...
		assertThat(costs, CoreMatchers.equalTo(18*7));
	}
	...
	public void valetParking24HoursOneMinute_costs30() {
		...
		assertThat(costs, CoreMatchers.equalTo(30));
	}
	...
	public void longTermGarageParkingZeroMinutes_costs0() {
		int costs = parkingCostsCalculator.selectLot("Long-Term Garage Parking")
		.setEntryDate("01/01/2001").setEntryTime("1:00").setEntryDayPart("am")
		.setLeavingDate("01/01/2001").setLeavingTime("1:00").setLeavingDayPart("am")
		.calculateCosts();
	...
	public void longTermGarageParkingoneWeek_costs78() {
		...
		assertThat(costs, CoreMatchers.equalTo(78));
	}
	...
	public void longTermGarageParking1Day_costs13() {
		...
		assertThat(costs, CoreMatchers.equalTo(13));
	}
	...
	public void longTermSurfaceParkingZeroMinutes_costs0() {
		int costs = parkingCostsCalculator.selectLot("Long-Term Surface Parking")
		.setEntryDate("01/01/2001").setEntryTime("1:00").setEntryDayPart("am")
		.setLeavingDate("01/01/2001").setLeavingTime("1:00").setLeavingDayPart("am")
		.calculateCosts();
	...
	public void longTermSurfaceParkingoneWeek_costs60() {
		...
		assertThat(costs, CoreMatchers.equalTo(60));
	}
	...
	public void longTermSurfaceParking1Day_costs10() {
		...
		assertThat(costs, CoreMatchers.equalTo(10));
	}
	...
	public void longTermSurfaceParking4hours_costs8() {
		...
		assertThat(costs, CoreMatchers.equalTo(8));
	}
	...
	public void economyParkingZeroMinutes_costs0() {
		int costs = parkingCostsCalculator.selectLot("Economy Lot Parking")
		.setEntryDate("01/01/2001").setEntryTime("1:00").setEntryDayPart("am")
		.setLeavingDate("01/01/2001").setLeavingTime("1:00").setLeavingDayPart("am")
		.calculateCosts();
	...
	public void economyParkingoneWeek_costs54() {
		...
		assertThat(costs, CoreMatchers.equalTo(54));
	}
	...
	public void economyParking1Day_costs9() {
		...
		assertThat(costs, CoreMatchers.equalTo(9));
	}
	...
	public void shortTermParkingZeroMinutes_costs0() {
		int costs = parkingCostsCalculator.selectLot("Short-Term (hourly) Parking")
		.setEntryDate("01/01/2001").setEntryTime("1:00").setEntryDayPart("am")
		.setLeavingDate("01/01/2001").setLeavingTime("1:00").setLeavingDayPart("am")
		.calculateCosts();
	...
	public void shortTermParkingOneDay_costs24() {
		...
		assertThat(costs, CoreMatchers.equalTo(24));
	}
	...
	public void shortTermParkingOneHour_costs2() {
		...
		assertThat(costs, CoreMatchers.equalTo(2));
	}
	...
	public void shortTermParking89Minutes_costs3() {
		...
		assertThat(costs, CoreMatchers.equalTo(3));
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void illegalLot(){
