...
public class LoginTest {
	...
	@Coverage(
		first = {
			@GoalCoverage(goal = "requirement coverage", item="R2", coverage={"logging in with protocol HTTP not allowed"}),
			@GoalCoverage(goal = "requirement coverage", item="R3", coverage={"check email and password fields after failed log-in"})
		}
	)
	@Test
